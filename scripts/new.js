 ...
 *
 * Ported from the Astro source project's `scripts/new.js`, retargeted at
 * this repo's `content/posts/<lang>/<slug>.md` layout (was
 * `src/content/posts/<lang>/<slug>.md` in Astro).
 *
